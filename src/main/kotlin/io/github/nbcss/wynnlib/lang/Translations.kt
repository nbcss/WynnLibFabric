...
object Translations {
    ...
    val TOOLTIP_ING_EFFECTIVENESS: Translatable = from("wynnlib.tooltip.ingredient_effectiveness")
    val TOOLTIP_ING_DURABILITY: Translatable = from("wynnlib.tooltip.ingredient_durability")
    val TOOLTIP_ING_DURATION: Translatable = from("wynnlib.tooltip.ingredient_duration")
    val TOOLTIP_ING_CHARGES: Translatable = from("wynnlib.tooltip.ingredient_charges")
    ...
    val TOOLTIP_POWDER_WEAPON: Translatable = from("wynnlib.tooltip.powder_on_weapon")
    val TOOLTIP_POWDER_ARMOUR: Translatable = from("wynnlib.tooltip.powder_on_armour")
    val TOOLTIP_POWDER_CRAFTING: Translatable = from("wynnlib.tooltip.powder_in_crafting")
}