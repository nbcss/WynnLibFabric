...
class CallOfTheHound(parent: Ability, json: JsonObject): BoundSpellEffect(parent, json),
    DamageProperty, DurationProperty {
    companion object: AbilityEffect.Factory {
        override fun create(parent: Ability, properties: JsonObject): CallOfTheHound {
            return CallOfTheHound(parent, properties)
        }
    }
