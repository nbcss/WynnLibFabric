...
class BoundingExtendProperty(ability: Ability, data: JsonElement): AbilityProperty(ability) {
    companion object: Factory {
        override fun create(ability: Ability, data: JsonElement): AbilityProperty {
            return BoundingExtendProperty(ability, data)
        }
        override fun getKey(): String = "bounding"
