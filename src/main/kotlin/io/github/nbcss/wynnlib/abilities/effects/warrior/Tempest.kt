...
class Tempest(parent: Ability, json: JsonObject): BoundSpellEffect(parent, json),
    DamageProperty, AreaOfEffectProperty {
    companion object: AbilityEffect.Factory {
        override fun create(parent: Ability, properties: JsonObject): Tempest {
            return Tempest(parent, properties)
        }
    }
