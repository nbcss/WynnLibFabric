...
class AbilityIcon(file: String) {
    companion object {
        private val UNKNOWN: AbilityIcon = AbilityIcon("unknown.png")
        private val iconMap: MutableMap<String, AbilityIcon> = mutableMapOf()
        ...
        fun reload() {
            ...
            for (entry in data.entrySet()) {
                ...
                iconMap[entry.key.uppercase()] = if (file == "") UNKNOWN else AbilityIcon(entry.value.asString)
            }
        }
