...
class BashSpell(parent: Ability, json: JsonObject): SpellUnlock(parent, json),
    DamageProperty, AreaOfEffectProperty, RangeProperty {
    companion object: AbilityEffect.Factory {
        override fun create(parent: Ability, properties: JsonObject): BashSpell {
            return BashSpell(parent, properties)
        }
    }
