...
class UppercutSpell(parent: Ability, json: JsonObject): SpellUnlock(parent, json),
    DamageProperty, AreaOfEffectProperty, RangeProperty {
    companion object: AbilityEffect.Factory {
        override fun create(parent: Ability, properties: JsonObject): UppercutSpell {
            return UppercutSpell(parent, properties)
        }
    }
