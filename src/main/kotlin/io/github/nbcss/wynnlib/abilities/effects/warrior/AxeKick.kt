...
class AxeKick(parent: Ability, json: JsonObject): SpellDamageModifier(parent, json),
    ...
    companion object: AbilityEffect.Factory {
        override fun create(parent: Ability, properties: JsonObject): AxeKick {
            return AxeKick(parent, properties)
        }
    }
    ...
    override fun getTooltipItems(): List<EffectTooltip> {
        return listOf(ManaCostModifierTooltip, DamageTooltip.Modifier)
    }
}